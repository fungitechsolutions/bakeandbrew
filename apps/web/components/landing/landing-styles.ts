...
export const landingSectionBodyClass =
  "font-(family-name:--font-dm-sans) text-[0.95rem] leading-[1.75] text-[rgba(47,78,64,0.6)]";
...
export const landingInputClass =
  "w-full border border-[rgba(47,78,64,0.18)] bg-white px-4 py-3 font-(family-name:--font-dm-sans) text-sm text-(--brand-ink) outline-none transition-colors focus:border-(--brand-green) focus:ring-2 focus:ring-[rgba(47,78,64,0.08)]";

export const landingPrimaryButtonClass =
  "inline-flex items-center justify-center gap-2 border border-(--brand-brown) bg-(--brand-brown) px-6 py-3 font-(family-name:--font-dm-sans) text-sm font-semibold text-white transition-all duration-200 hover:-translate-y-0.5 hover:brightness-105";

export const landingSecondaryButtonClass =
  "inline-flex items-center justify-center gap-2 border border-[rgba(47,78,64,0.2)] bg-white px-5 py-2.5 font-(family-name:--font-dm-sans) text-sm font-semibold text-(--brand-green) transition-colors hover:bg-[rgba(47,78,64,0.04)]";

export const landingNavLinkClass =
  "relative font-(family-name:--font-dm-sans) text-[0.9rem] font-medium tracking-[0.02em] text-[rgba(26,26,26,0.6)] transition-colors duration-200 hover:text-(--brand-green) after:absolute after:-bottom-1 after:left-0 after:h-px after:w-0 after:bg-(--brand-brown) after:transition-[width] after:duration-300 hover:after:w-full";
