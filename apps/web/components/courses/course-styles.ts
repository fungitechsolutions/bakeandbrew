...
export const courseBodyClass =
  "font-[family-name:var(--font-dm-sans)] text-[0.95rem] leading-[1.75] text-[rgba(47,78,64,0.62)]";
...
export const coursePrimaryBtnClass =
  "inline-flex items-center justify-center gap-2 border border-(--brand-brown) bg-(--brand-brown) px-6 py-3 font-[family-name:var(--font-dm-sans)] text-sm font-semibold text-white transition-all duration-200 hover:-translate-y-0.5";

export const courseSecondaryBtnClass =
  "inline-flex items-center justify-center gap-2 border border-[rgba(255,255,255,0.28)] bg-[rgba(255,255,255,0.06)] px-6 py-3 font-[family-name:var(--font-dm-sans)] text-sm font-semibold text-white transition-colors hover:border-[rgba(255,255,255,0.45)] hover:bg-[rgba(255,255,255,0.1)]";
...
export const coursePriceVatNoteClass =
  "font-[family-name:var(--font-dm-sans)] text-[0.68rem] leading-snug text-[rgba(47,78,64,0.45)]";
