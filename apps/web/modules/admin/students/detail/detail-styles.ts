...
export const detailEmptyIconWrapClass =
  "grid h-8 w-8 place-items-center rounded-full border border-[rgba(47,78,64,0.12)] bg-[rgba(47,78,64,0.03)] text-[rgba(47,78,64,0.35)] sm:h-10 sm:w-10";
...
export const detailEmptyActionIconClass = "h-3 w-3 shrink-0 sm:h-3.5 sm:w-3.5";
