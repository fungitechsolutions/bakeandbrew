  ...
  return (
    <div className="mb-6 grid grid-cols-1 gap-px border border-[rgba(47,78,64,0.18)] bg-[rgba(47,78,64,0.18)] sm:grid-cols-2">
      <div className="relative overflow-hidden bg-(--brand-green) px-6 py-5">
        ...
        <p className="relative font-(family-name:--font-dm-sans) text-[10px] font-semibold uppercase tracking-[0.12em] text-white/65">
          {primaryLabel}
        </p>
        {isLoading ? (
          <div className="relative mt-3 h-9 w-44 animate-pulse bg-white/15" />
        ) : (
          <p className="relative mt-2 font-(family-name:--font-lora) text-3xl font-bold tracking-tight text-(--brand-brown)">
            {primaryValue}
          </p>
        )}
        <p className="relative mt-1 font-(family-name:--font-dm-sans) text-xs text-white/55">
          {primaryHint}
        </p>
      </div>
      ...
      <div className="bg-white px-6 py-5">
        ...
        {isLoading ? (
          ...
          <p className="mt-2 font-(family-name:--font-lora) text-4xl font-bold tracking-tight text-(--brand-green)">
            {secondaryValue}
          </p>
        )}
